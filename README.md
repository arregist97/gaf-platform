...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create gaf-platform-1112
  fly apps create gaf-platform-1112-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app gaf-platform-1112
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app gaf-platform-1112-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'gaf-platform-1112-staging' does not match app name in config file 'gaf-platform-1112'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name gaf-platform-1112-db
  fly postgres attach --app gaf-platform-1112 gaf-platform-1112-db

  fly postgres create --name gaf-platform-1112-staging-db
  fly postgres attach --app gaf-platform-1112-staging gaf-platform-1112-staging-db
  ```
